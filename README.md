...
You install this once. In any React, React Native, or JS/TS repo you say:
...
Or copy `skills/test-swarm` into this project's `.cursor/skills/test-swarm` so teammates get it.
...
5. Spawns up to 10 local agents on disjoint folders. Each must hit 95/95 on its slice.
